  ...
  return (
    <div className='header'>
      <div className='project-emblem'>
        <svg xmlns='http://www.w3.org/2000/svg' width='80px' height='100px' viewBox='0 0 30 25'>
          <path
            id='drop-anim'
            fill='rgb(94, 163, 200)'
            d='M4.2,18.8c-0.4,0.6-0.9,1.5-1.2,2c-0.4,0.9-0.5,1.1-0.5,1.8c0,0.9,0.2,1.4,1,1.8c0.7,0.4,2.4,0.4,2.9,0
	c1-0.7,1.3-1.6,0.8-2.9c-0.3-0.8-1.5-2.9-2.1-3.5l-0.3-0.3L4.2,18.8z M3.6,21.3'
          />
          <path
            fill='rgb(178, 178, 178)'
            d='M16.1,0.8c-0.3,0.1-0.6,0.3-0.8,0.5c-0.3,0.3-0.5,0.3-2.9,0.3c-2.3,0-2.6,0-3.1-0.3C9,1.1,8.5,1,8.3,1H7.8v1.5
